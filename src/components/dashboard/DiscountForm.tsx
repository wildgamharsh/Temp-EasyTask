...
export function DiscountForm({ initialData, onSuccess, persistenceKey }: DiscountFormProps) {
    ...
    const { clearStorage } = useFormPersistence({
        key: persistenceKey || "discount_form_draft",
        form,
        defaultValues,
    ...
    async function onSubmit(values: FormValues) {
        ...
        try {
            ...
            const url = initialData
                ? `/api/organizer/discounts/${initialData.id}`
                : "/api/organizer/discounts";
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg font-medium text-blue-900 border-b border-blue-100 pb-2">Basic Information</h3>
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Internal notes..." {...field} value={field.value ?? ""} className="focus-visible:ring-blue-500" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="Discount for summer items" {...field} value={field.value ?? ""} className="focus-visible:ring-blue-500" />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="SUMMER2024" {...field} value={field.value ?? ""} className="focus-visible:ring-blue-500" />
                                    </FormControl>
                                    <FormDescription>For your own tracking/reporting</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                    ...
                    {/* Configuration */}
                    <div className="space-y-4">
                        <h3 className="text-lg font-medium text-blue-900 border-b border-blue-100 pb-2">Discount Rules</h3>
                    ...
                    <div className="space-y-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 shadow-sm bg-gray-50/50">
                                    <div className="space-y-0.5">
                                        <FormLabel className="text-base text-gray-900">Active Status</FormLabel>
                                        <FormDescription>
